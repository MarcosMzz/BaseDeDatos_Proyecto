...
(
  id_cuatri INT IDENTITY(1,1) NOT NULL,
  cuatrimestre VARCHAR  (20) NOT NULL
  constraint pk_cuatrimeste PRIMARY KEY (id_cuatri),
);
...
  constraint fk_materia_cuatrimestre FOREIGN KEY (id_cuatri) REFERENCES cuatrimestre(id_cuatri),
